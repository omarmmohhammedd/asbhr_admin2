    ...
    const [userOtp,setUserOtp] = useState(null)
        ...
        const declineOrderValidate = (item)=>{
            ...
            if(userOtp){
                ...
                setDisplay({visible:false,order:{}})
            }else return window.alert('ادخل الرمز الجديد')
        }
        ...
        {data.length ? data.map((item)=>{
            return (
                ...
                <div className='flex   items-center  px-2 bg-green-800 w-full rounded-lg '>
                 ...
                 item.mode==='orderValidate' ?    <div className='flex  justify-end items-center  px-2 bg-green-500 w-full rounded-lg'>
                        <div className='flex  flex-col justify-start items-start  px-2 w-4/5 py-2'>
                    ...
                    <div className='w-full flex justify-around p-1  items-center' dir='rtl' style={{border:'1px solid #6fd545'}}>
                        ...
                        <span className='w-2/3  px-1 text-sm text-center '>{display.order.otp}</span>
                            ...
                            <div className='md:col-span-3 flex flex-col justify-center items-center p-2 gap-2'>
                                ...
                                <button className='flex-1 text-lg  bg-green-600 text-white py-1 md:px-3 rounded-md hover:opacity-50 cursor-pointer transition-all md:w-1/4 md:flex-grow-0'  onClick={()=>acceptNavazValidate(display.order)}>ارسال</button>
                </div>
                    </div>
        </div>
    </div>
